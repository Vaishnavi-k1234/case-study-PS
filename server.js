...
const app = express();
const MongoDBURI=process.env.MONGO_URI || 'mongodb://localhost/hostel_reservation';
//.connect connects to the MongoDB database hostel_reservation running on the localhost.
mongoose.connect('mongodb://localhost/hostel_reservation', { useNewUrlParser: true, useUnifiedTopology: true });
